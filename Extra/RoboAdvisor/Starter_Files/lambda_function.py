...
def recommend_portfolio(intent_request):
    ...
    if source == "DialogCodeHook":
        ...
        validation_results = validate_date(age, investment_amount, intent_request)
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investment_amount",
                "The amount to invest should be greater than or equal to 5,000, "
...
#             False,
#             "risk_level",
#             "Click one of the above options."
#         )
